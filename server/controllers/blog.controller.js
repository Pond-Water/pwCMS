...
var pageService = require('server/services/page.service');
var postService = require('server/services/post.service');
var redirectService = require('server/services/redirect.service');
var slugify = require('server/helpers/slugify');
var pager = require('server/helpers/pager');

var basePath = path.resolve('client/blog');
var indexPath = basePath + '/index';
var metaTitleSuffix = " | Pond-Water CMS - A CMS and Blog platform";
...
router.get('/', function (req, res, next) {
    ...
    //TODO: verify pageSize
    vm.pager = pager(vm.posts.length, currentPage, vm.pageSize);
